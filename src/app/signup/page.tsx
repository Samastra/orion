      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-950 via-background to-background items-center justify-center p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md space-y-8">
          ...
          <div className="flex gap-6 pt-4">
            {['Free to Start', 'AI Powered', 'Secure', 'Fast'].map((tag) => (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest ml-1">Full Name</label>
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/40" />
                  <input
                    name="fullName"
                    type="text"
                    required
                    placeholder="Samuel J."
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest ml-1">Nickname</label>
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/40" />
                  <input
                    name="nickname"
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest ml-1">Password</label>
              <div className="relative">
