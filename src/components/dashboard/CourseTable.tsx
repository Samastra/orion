      ...
      <div className="flex items-center justify-between">
        <Tabs defaultValue="outline" className="w-auto">
          <TabsList className="bg-white/5 border border-white/5 h-10 p-1 rounded-xl">
            ...
            <TabsTrigger value="performance" className="rounded-lg px-4 data-[state=active]:bg-white/10">Performance</TabsTrigger>
          </TabsList>
        </Tabs>
              ...
              courses.map((course) => (
                <TableRow key={course.id} className="border-white/5 hover:bg-white/[0.04] group transition-colors">
                  ...
                  <TableCell className="py-4">
                    <Badge variant="outline" className="rounded-full bg-indigo-500/10 border-indigo-500/20 text-indigo-400 font-medium px-3">
                      {course.type}
                    </Badge>
                  </TableCell>
